use {
    crate::{AccountDeltaProof, AccountHashMap, Data, Proof},
    blake3::traits::digest::Digest,
    rayon::{
        iter::{IntoParallelIterator, ParallelIterator},
        prelude::*,
    },
    solana_accounts_db::accounts_hash::{AccountHash, AccountsHasher, MERKLE_FANOUT},
    solana_sdk::{
...
pub fn calculate_root(pubkey_hash_vec: Vec<(Pubkey, AccountHash)>) -> Hash {
...
#[cfg(test)]
mod tests {
    use {super::*, rand::Rng, solana_sdk::hash::hashv, std::convert::TryFrom};
